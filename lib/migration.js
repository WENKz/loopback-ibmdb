...
var debug = require('debug')('loopback:odbc');

module.exports = function(ODBCConnector) {
  ODBCConnector.prototype.showFields = function(model, cb) {
    var self = this;
  ...
  ODBCConnector.prototype.showIndexes = function(model, cb) {
    var self = this;
  ...
  ODBCConnector.prototype.getColumnsToAdd = function(model, actualFields) {
    var self = this;
  ...
  ODBCConnector.prototype.getColumnsToDrop = function(model, actualFields) {
    var self = this;
  ...
  ODBCConnector.prototype.dropIndexes = function(model, actualIndexes) {
    var self = this;
    var operations = [];
  ...
  ODBCConnector.prototype.alterTable = function(model, actualFields, actualIndexes,
    callback, checkOnly) {
    debug('ODBCConnector.prototype.alterTable %j %j %j %j',
